...
var Player = function(game, grid, soundStrings) {
    ...
    Phaser.Sprite.call(this,
        game,
        pixel.x * scaleFactor, pixel.y * scaleFactor,
        'viking');
...
Player.prototype.update = function() {
    ...
    if (this.soundCounter < 0) {
        ...
        if (this.grid.x * scaleFactor < 0 || this.grid.y * scaleFactor < 0 ||
            this.grid.x * scaleFactor >= SCREEN_WIDTH / TILE_SIZE || this.grid.y * scaleFactor >= SCREEN_HEIGHT / TILE_SIZE) {
